    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_kategoriler', models.ManyToManyField(to='todoapp.altkategoriler')),
                ('kategori', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='todoapp.kategori')),
            ],
        ),
    ]
